...
//  Wreckpointer
//
//  Created by Danylo Ternovoi on 30.03.2023.
//
...
extension CKManager {
    ...
    static func getUserName(forID userID: CKRecord.ID,
...
extension CKManager {
    ...
    static func add<T: CKCodable>(item: T,
    ...
    static func addWithReference<T: CKCodable,
                                 C: CKCodable>(fromItem childItem: T,
                                               toItem parentItem: C,
    ...
    static func fetch<T:CKCodable>(predicate: NSPredicate,
    ...
    static func fetchReferences<T: CKCodable,
                                C: CKCodable>(forItem owner: T,
